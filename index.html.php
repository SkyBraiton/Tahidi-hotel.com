...
<tr>
    ...
    <td>"Everything is absolutely<br>perfect at Tahidi Hotel"</td> 
    <td>"Great location, great staff<br>Great Value!"</td>
</tr>
</table>
<h2 class="main2"  id="booknow">Book Now</h2>
<form action="xxx.php" method="post">
<table class="table3" align="center" style="background-color:blue">
<tr>
